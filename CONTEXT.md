...
│   ├── app/
│   │   ├── main.py         # FastAPI app (version="1.8.0"), endpoints REST + sirve /static
...
│       └── __init__.py
└── frontend/
    ├── package.json        # pf2e-elhoss-sheet v1.8.0 · React 18 · Vite 5 · TypeScript
    ...
    └── src/
        ...
        └── lib/
            ├── languages.ts# Lista Elhoss/SRD y merge al elegir ancestría
            ├── portrait.ts # Comprime el retrato (JPEG 360×480) antes de guardarlo
...
Character {
  // identidad
  name, player, xp, level, heroPoints, portrait
  ...
  money: ElhossMoney  // Thaloré, Orivan, Thalmar, Syran, Syri, Ran
  languages: string[]
...
| 1.6.1 | 2026-08-12 | Thalmar (grafía), Talore, nombres solo Elhoss |
| 1.7.0 | 2026-08-12 | Moneda Thalan'dorœ: Thaloré / Orivan / Thalmar / Syran / Syri / Ran |
