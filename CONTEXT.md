...
│   ├── app/
│   │   ├── main.py         # FastAPI app (version="1.7.0"), endpoints REST + sirve /static
...
│       └── __init__.py
└── frontend/
    ├── package.json        # pf2e-elhoss-sheet v1.7.0 · React 18 · Vite 5 · TypeScript
